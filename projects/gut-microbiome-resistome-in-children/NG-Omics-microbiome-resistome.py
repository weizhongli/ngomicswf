...
#  'CMD_opts'       : ['host/GRCh38.fa','total_RNA/total_RNA'],  # 1st option db1 for filtering against host, metaG and metaT, NONE to skip
  ...
  'execution'      : 'qsub_1',        # where to execute
  'cores_per_cmd'  : 24,              # number of threads used by command below
  'no_parallel'    : 1,               # number of total jobs to run using command below
  'command'        : '''
...
NGS_batch_jobs['minimap-binning-2020'] = {
  ...
  'CMD_opts'       : ['0.01','ref-genomes-2020-0622/bwa/ref_full.fna','ref-genomes-2020-0622/bwa/ref_full.fna.header',
                      'ref-genomes-2020-0622/refseq_genome_taxon.tsv','ref-genomes-2020-0622/bwa/ref_full.taxid.len'],
...
NGS_batch_jobs['blast-kegg-parse'] = {
  'injobs'         : ['blast-kegg','cd-hit-kegg','ORF-prediction','minimap-binning-2020','assembly'],
  'CMD_opts'       : ['kegg/keggf_taxon.txt', 'ref-genomes-2020-0622/refseq_genome_taxon.tsv', 'kegg/keggf.clstr.ann', 'kegg/ko00002-M00178.keg'],
  'execution'      : 'qsub_1',        # where to execute
...
NGS_batch_jobs['RGI'] = {
  'injobs'         : ['ORF-prediction','minimap-binning-2020'],
...
#### delete below no use
#### $ENV.NGS_root/NGS-tools/JCVI/ann_parse_RGI.pl -i $SELF/rgi.out.txt -o $SELF/count-rgi.out -b $INJOBS.1/assembly-bin
