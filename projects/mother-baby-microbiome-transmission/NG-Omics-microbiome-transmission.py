...
ENV={
  'NGS_root' : '/PATH_NGS_root_directory',
}
...
if [ "$CMDOPTS.0" = "bwa" ]
then
  $ENV.NGS_root/apps/bin/bwa mem -t 16 -T 60 /local/ifs2_projdata/9600/projects/BIOINFO/refs/host/GRCh38.fa \\
...
$ENV.NGS_root/NGS-tools/ann_ORF_taxon_func_kegg.pl -i $SELF/ORF-ann.txt -d $INJOBS.3/ORF-cov -k $ENV.NGS_root/refs/kegg/ko00001-biome.keg -o $SELF/ORF-ann-kegg-pathway -r $ENV.NGS_root/refs/kegg/ko00002-M00178.keg
$ENV.NGS_root/NGS-tools/ann_ORF_taxon_func_kegg.pl -i $SELF/ORF-ann.txt -d $INJOBS.3/ORF-cov -k $ENV.NGS_root/refs/kegg/ko00002-edit.keg -o $SELF/ORF-ann-kegg-module -r $ENV.NGS_root/refs/kegg/ko00002-M00178.keg
$ENV.NGS_root/NGS-tools/ann_ORF_taxon_func_kegg.pl -i $SELF/ORF-ann.txt -d $INJOBS.3/ORF-cov -k $ENV.NGS_root/refs/kegg/ko01000.keg -o $SELF/ORF-ann-kegg-EC -r $ENV.NGS_root/refs/kegg/ko00002-M00178.keg
$ENV.NGS_root/NGS-tools/ann_ORF_taxon_func_kegg.pl -i $SELF/ORF-ann.txt -d $INJOBS.3/ORF-cov -k $ENV.NGS_root/refs/kegg/ko02000.keg -o $SELF/ORF-ann-kegg-transporter -r $ENV.NGS_root/refs/kegg/ko00002-M00178.keg
$ENV.NGS_root/NGS-tools/ann_ORF_taxon_func_kegg.pl -i $SELF/ORF-ann.txt -d $INJOBS.3/ORF-cov -k $ENV.NGS_root/refs/kegg/ko01504.keg -o $SELF/ORF-ann-kegg-AMR -r $ENV.NGS_root/refs/kegg/ko00002-M00178.keg

$ENV.NGS_root/NGS-tools/ann_ORF_taxon_func_kegg_per_sp.pl -i $SELF/ORF-ann.txt -d $INJOBS.3/ORF-cov -k $ENV.NGS_root/refs/kegg/ko00001-biome.keg -o $SELF/sp50-pathway -c 0.5 -r $ENV.NGS_root/refs/$CMDOPTS.3
$ENV.NGS_root/NGS-tools/ann_ORF_taxon_func_kegg_per_sp.pl -i $SELF/ORF-ann.txt -d $INJOBS.3/ORF-cov -k $ENV.NGS_root/refs/kegg/ko00002-edit.keg  -o $SELF/sp50-module  -c 0.5 -r $ENV.NGS_root/refs/$CMDOPTS.3
$ENV.NGS_root/NGS-tools/ann_ORF_taxon_func_kegg_per_sp.pl -i $SELF/ORF-ann.txt -d $INJOBS.3/ORF-cov -k $ENV.NGS_root/refs/kegg/ko01000.keg       -o $SELF/sp50-EC      -c 0.5 -r $ENV.NGS_root/refs/$CMDOPTS.3
...
NGS_batch_jobs['RGI'] = {
  'injobs'         : ['ORF-prediction','assembly-binning'],
  'CMD_opts'       : [],
...
PATH=/local/ifs2_projdata/9600/projects/BIOINFO/apps/blast+/bin/:/usr/local/bin:$PATH
export PATH

## rgi main --input_sequence $INJOBS.0/ORF.faa --output_file $SELF/rgi.out --input_type protein
## rm -f $SELF/ORF.faa.temp.*

/home/wli/git/ngomicswf/NGS-tools/JCVI/ann_parse_RGI.pl -i $SELF/rgi.out.txt -o $SELF/rgi.out -a $INJOBS.0/ORF-cov -b $INJOBS.1/assembly-bin
